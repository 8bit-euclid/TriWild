...
namespace triwild
{
    ...
    void do_triwild(const Eigen::MatrixXd &V_in,
                    ...
                    double stop_quality = args.stop_quality,
                    int max_its = args.max_its,
                    int stage = args.stage,
                    double epsilon = args.epsilon,
                    double feature_epsilon = args.feature_epsilon,
                    double target_edge_len = args.target_edge_len,
                    double edge_length_r = args.edge_length_r,
